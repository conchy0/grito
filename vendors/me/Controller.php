...
abstract class Controller
{
    ...
    {
        if (isset($_COOKIE["logat"]) && $_COOKIE["logat"] == true) {
            $this->logat = true;
            $this->logat_user = $_COOKIE["logat_user"];
        } elseif (isset($_SESSION["logat"])) {
    ...
    protected function login($user)
    {
        ...
        // Crear cookies de 24 hores
        setcookie("logat_user", $user, time() + 86400, "/", "", false, true);
        setcookie("logat", true, time() + 86400, "/", "", false, true);
    ...
    protected function logout()
    {
        ...
        setcookie("logat_user", "", time() - 3600, "/");
    ...
    public function renderView($error = null)
    {
        ...
        if (isset($this->data["missatge"]))
            $this->controller->data["missatge"] = $this->data["missatge"];
